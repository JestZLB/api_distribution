...
export function AppShell() {
  ...
  return (
    <div className="h-screen w-full flex bg-bg">
      <aside
        className={cn(
          'shrink-0 flex-col bg-bg-elevated border-r border-border transition-[width] duration-200',
          collapsed ? 'w-16' : 'w-58',
        )}
      >
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-bg">
        ...
        <main className="flex-1 overflow-y-auto px-6 py-8 sm:px-10 sm:py-12 lg:px-16 lg:py-14 bg-bg">
